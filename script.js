...
setTimeout(() => {
    ...
    alert("I could have came up with a much more efficient coding solution. But honestly, this project was way too easy and I don\'t have the energy to write more efficient code. Sorry.")
